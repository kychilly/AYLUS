...
public class Z_GPTCommand {

    // Command pulled from KycheGPT project
    ...
    public static CommandData getCommandData() {
        return Commands.slash("ask", "Ask the AYLUS bot a question!")
                .addOption(OptionType.STRING,"prompt", "What do you want to ask the AYLUS bot?", true);
    }
    ...
    public static String getDescription() {
        // Put the bot description here
        return "You are the AYLUS bot for Discord designed to help users manage and navigate this bot. There are a few commands the users \n" +
                "might use. These are the user commands:" +
                "/volunteering-profile, which can take a User parameter(the @ of a person) and get their profile\n" +
                "/volunteering-leaderboard, which gets the leaderboard of the most volunteer hours had\n" +
                "Additionally, there are a few moderator commands, which are /volunteer-log, which has a few parameters, but \n" +
                "they are not for the general public. Contact Jeffrey via [mailto][jyam478@gmail.com] or <@8402163337119969301> for these commands if needed." +
